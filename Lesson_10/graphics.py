...
def get_text(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        box = messagebox.showinfo("Победа!", "Игрок 1 Выйграл")
    elif winner(board, "O"):
        gb.destroy()
        box = messagebox.showinfo("Победа!", "Player 2 Выйграл")
    elif (isfull()):
        gb.destroy()
...
def get_text_pc(i, j, gb, l1, l2):
    ...
    if winner(board, "X"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Победа!", "Вы обыграли компьютер)")
    elif winner(board, "O"):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Поражение!", "Компьютер выйграл")
    elif (isfull()):
        gb.destroy()
        x = False
        box = messagebox.showinfo("Ничья", "Ничья")
...
def play():
    ...
    head = Button(menu, text="---Игра крестики - нолики---",
                  activeforeground='red',
                  activebackground="yellow", bg="red",
                  fg="yellow", width=500, font='summer', bd=4)
    ...
    B2 = Button(menu, text="Игра на двоих", command=wpl, activeforeground='red',
